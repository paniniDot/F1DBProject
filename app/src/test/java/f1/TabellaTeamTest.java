...
class TabellaTeamTest {
    ...
    void IncrementCampionatiVintiTest() {
    	...
    	assertEquals(tabTeam.findByPrimaryKey(team1.getIdTeam()).get().getCampionatiVinti(), team1.getCampionatiVinti());
    	assertEquals(tabTeam.findByPrimaryKey(team1.getIdTeam()).get().getCampionatiVinti(), 3);
    	assertEquals(tabTeam.findByPrimaryKey(team2.getIdTeam()).get().getCampionatiVinti(), team2.getCampionatiVinti());
