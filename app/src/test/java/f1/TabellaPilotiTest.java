...
class TabellaPilotiTest {
	...
	final Pilota pil1 = new Pilota("PNNMTT01S28D488Z", "Mattia", "Panni", Utils.buildDate(28, 11, 2001).get(),
			"Via Rinalducci 65, Fano (PU)");
	final Pilota pil2 = new Pilota("FRNRCD01S29E599A", "Riccardo", "Fiorani", Utils.buildDate(12, 1, 2001).get(),
			"Via Salamini 6, Fano (PU)");
	...
	void findByNameAndSurnameTest() {
		final Pilota pil3 = new Pilota("ABCDEFGHIL123456", "Mattia", "Panni", Utils.buildDate(11, 10, 1998).get(),
				"via Spadoni 3");
		tabPiloti.save(pil1);
		tabPiloti.save(pil2);
		tabPiloti.save(pil3);
